...
class pratices(models.Model):
    ...
    file_field = models.FileField(upload_to='practice/')
    file_path_field = models.FilePathField(path='practice')
    ...
    # one_to_one_field = models.OneToOneField(, on_delete=models.CASCADE)
