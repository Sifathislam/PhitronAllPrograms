...
int main(){
    ...
    // It works dynamic 
    capacty_size = "Hello Sifat nice to meet you";
    cout<< "Find the capacity of an string with capacity() " << capacty_size.capacity()<< endl;
    // It works dynamic 
    capacty_size = "Hello Sifat nice to meet you? what are your hobby";
    cout<< "Find the capacity of an string with capacity() " << capacty_size.capacity()<< endl;
    
    // NO:4)- Clear any string 
    string clr_string = "Hello hi there is sifath talking with you";
